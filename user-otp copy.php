...
<style>
  ...
  background-size: cover;">
      <div class="login-box">
  <h2>Code Verification <?php echo  $email?></h2>
  ...
  <?php 
                    ...
                    ?>
    <div class="user-box">
      <input type="number" name="otp" required value="<?php echo $email ?>">
      <label>OTP code</label>
    </div>
    <div style="color: white;"><a href="user-otp-reset-code.php">resend</a></div>
