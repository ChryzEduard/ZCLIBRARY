                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5" id="mennues">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                <a class="text-light mb-2" href="index.php"><i class="bi bi-book text-white me-2"></i>Home</a>
                                <a class="text-light mb-2" href="login-user.php"><i class="bi bi-book  text-white me-2"></i>Resources/Collection</a>
                                <a class="text-light mb-2" href="announcements.php"><i class="bi bi-book  text-white me-2"></i>Announcement</a>
                                <a class="text-light mb-2" href="blog.php"><i class="bi bi-book  text-white me-2"></i>Blogs</a>
                                  
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5" id="map">
                            <div class="section-title-sm position-relative pb-3 mb-1">
                             
                                <h4 class="text-light ">Visit Us Hear <i class="bi bi-geo-alt text-white me-2"></i></h4>
                            </div>
