...
<?php include "header.php"?>
    ...
    <div class="card-header">
        ...
        <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
            ...
            <img src="../alluserprofiles/<?php echo $fetch_info['libraryUserpicture']?>" alt="<?php echo $fetch_info['libraryUserpicture']?>" width="200px" height="200px">
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control <?php echo $inputdataforfirst?>" id="validationServer01" value="<?php echo $accdetailes['libraryUserFirtsName']?>" placeholder="First Name" name="firstname">
                    <div class="<?php echo $feedbackdataforfirst?>"><?php echo $feedbackTextforfirst?></div>
                </div>

                <div class="col-md-4 mb-3">
                    <label for="validationServer01">Last name</label>
                    <input type="text" class="form-control <?php echo $inputdataforlast?>" id="validationServer01" value="<?php echo $accdetailes['libraryUserLastName']?>" placeholder="Last Name" name="lastname">
                    <div class="<?php echo $feedbackdataforlast?>"><?php echo $feedbackTextforlast?></div>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="validationServer01">Age</label>
                    <input type="number" class="form-control <?php echo $inputdataforage?>" id="validationServer01" value="<?php echo $accdetailes['libraryUseAge']?>" placeholder="Age" name="agecal">
                    <div class="<?php echo $feedbackdataforage?>"><?php echo $feedbackTextforage?></div>
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="validationServer01">Contact Number</label>
                    <input type="text" class="form-control <?php echo $inputdatafornumber?>" id="validationServer01"  value="<?php echo $accdetailes['contactNumber']?>" placeholder="Contact" name="numbercal">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control <?php echo $inputdataforaddress?>" id="validationServer01" value="<?php echo $accdetailes['librarylocation']?>"  placeholder="Address" name="addresscal">
