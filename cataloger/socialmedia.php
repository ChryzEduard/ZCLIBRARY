        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="card-title">Setting Social Media </h4>
                    <div class="line">
                    </div>
                    <?php
                    if(count($errors) == 1){
                    ...
                    <button type="submit" class="btn btn-primary" name="addsoc">Add Social Media</button>
                ...
                <tbody>
                    ...
                    <?php  while($soclist = mysqli_fetch_array($soc)){?>
                        <tr>
                        <td class="text-nowrap"><a style ="font-size: 30px;"href="<?php echo $soclist['iconLink']?>" class="fab <?php echo $soclist['iconLogo']?>  fw-normal"></a></td>
                       <td class="text-end py-0 align-middle">
                      <div class="btn-group btn-group-sm">
						 <a href="socialmedia.php?delete_id=<?php echo $soclist["socialMediaID"]; ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm bg-danger-light"><i class="fe fe-trash"></i></a>
                      </div>
                    </td> </tr>
                    <?php } ?>
                </tbody>
