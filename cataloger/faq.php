...
if(isset($_GET['delete_id']))
    ...
    $insertdata = mysqli_query($con,"UPDATE posst SET posst_cath='$cathegory', posst_pic='$lis_img0', posst_pic_src='$posst_pic_src', posst_title='$posst_title', posst_desc='$posst_desc', date='$today' where posst_id=".$edit."");
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="card-title">Add Frequently ask questions</h4>
                    <div class="line"></div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="col-lg-9">
                    <textarea rows="4" cols="5" class="form-control" placeholder="Enter Description" name="desc" <?php echo $showfaq['description']?>><?php echo $showfaq['description']?></textarea>
                    </div>
                    </div>
                ...
                <tbody>
                    ...
                    while($faqlist = mysqli_fetch_array($faq)){?>
                      ...
                      <div class="btn-group btn-group-sm">
						<a href="faq.php?edit=<?php echo $faqlist["faqID"]; ?>" onclick="return confirm('Are you sure?')"  class="btn btn-sm bg-success-light me-2btn btn-sm bg-success-light me-2"><i class="fe fe-pencil"></i></a>
                        <a href="faq.php?delete_id=<?php echo $faqlist["faqID"]; ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm bg-danger-light"><i class="fe fe-trash"></i></a>
                      </div>
                    </td> </tr>
