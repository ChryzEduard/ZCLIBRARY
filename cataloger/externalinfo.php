...
if(isset($_POST['external_submit'])){
    ...
    if ($flagsystemname == false && $flagaboutus == false && $flagcontactus == false && $flagemail == false  && $flagaddress == false) {
        $sql = "SELECT * FROM libraryuser WHERE libraryUserId = $id";
        $result = mysqli_query($con, $sql);
        if (mysqli_num_rows($result) > 0) {
            $sql = "update external_info set siteTitle = '$systemname', about_us ='$aboutus',siteContact = '$contactus', siteEmail = '$email',siteAddress = '$address' , date = '$date', libraryUserId = '$id' where externalID = '1'";
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="card-header">
                        <h5 class="card-title">System External Details</h5><div class="line"></div><br>
                        ...
                        <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                            ...
                            <button class="btn btn-primary" type="submit" name = "external_submit">Submit form</button>
                        </form>
                        </div>
                        </div>
                </div>
