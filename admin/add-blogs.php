...
error_reporting(0);
    ...
    if($editq==''){
        ...
        if(empty($title)){
            $errors['title'] = "Please provide a Blog title";
        }
        if(empty($lis_img0)){
            $errors['lis_img0'] = "Please provide a Blog profile";
        }
       
        if(empty($cont)){
            $errors['cont'] = "please provide a Blog description";
        }
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                            <a href="blogs.php"><button type="button" class="btn btn-block btn-outline-light" style="border : 1px solid black">Back</button></a>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                                <label class="col-form-label col-md-2">Profile</label>
                                    <div class="col-md-10">
                                        <input type="file"  name="lis_img0" value="<?php echo $editblogs['contProfile']?>">
                                    </div>
                                    </div>
                            <div class="form-group row">
