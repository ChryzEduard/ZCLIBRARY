...
if(isset($_GET['delete_id']))
    ...
    if($editq==''){
        ...
        if(empty($section_desc)){
            $errors['section_desc'] = "Please Proved a Section Description";
        }
        if(empty($lis_img0)){
            $errors['lis_img0'] = "Please Proved a Section Image Profile";
        }
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="fi fi-rr-square-plus"></i> Add Sections</h4>
                                    <div class="line"></div><br><br>
                                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                                         <a href="Sections.php"><button type="button" class="btn btn-block btn-outline-dark"><i class="fi fi-rr-left"></i> Back</button></a>
                                     </div>
                                 </div>
                             <div class="card-body">
