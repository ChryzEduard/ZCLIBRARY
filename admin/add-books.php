...
if(isset($_GET['delete_id']))
    ...
    if($editq==''){
        ...
        if(empty($dewey)){
            $errors['dewey'] = "Please Proved a Dewey Decimal ";
        }
    ...
    $insertdata = mysqli_query($con,"UPDATE books SET isbn='$isbn',Deweydecimal='$dewey', sectionID='$section', libraryUserId='$id', bookprofile='$lis_img0',bookTitle='$title',bookAuthors='$bookauthor',bookSubject='$subject',bookPublisher='$publisher',bookDescription='$smalldesc', bookPlacePublisher='$placepublished', bookSource='$source' where bookId=".$editq."");
            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                             ...
                             <div class="card-header">
                                <h4 class="card-title"><i class="fi fi-rr-book-open-cover"></i> Add Books</h4>
                                    <div class="line"></div>
                    ...
                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <label class="col-lg-3 col-form-label">Author</label>
                                                    <div class="col-lg-9">
                                                        <textarea name="bookauthor" class="form-control"><?php echo $boook['bookAuthors']?></textarea>
                                                    </div>
                                                </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="text-end">
                                <button type="submit" class="btn btn-primary" name="booksubmit"><i class="fi fi-rr-book-open-cover"></i> Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
