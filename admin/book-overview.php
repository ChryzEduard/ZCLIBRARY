...
error_reporting(0);
    ...
    {
        $editq = $_GET['overview'];
        $editbooks = mysqli_query($con,"select books.bookId , books.isbn ,books.Deweydecimal ,books.bookprofile ,books.bookTitle ,books.bookSubject ,books.bookAuthors ,books.bookDescription ,books.bookSource ,books.bookPublisher ,books.bookPlacePublisher , section.Section_Name from books join section on section.sectionID =  books.sectionID where books.bookId =".$editq."");
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input class="form-control" value="<?php echo $boook['Deweydecimal']?>" disabled>
                                                        </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Section </label>
                                                    <div class="col-lg-9">
                                                    <input type="text" class="form-control" value="<?php echo $boook['Section_Name']?>" disabled>
                                                    </div>
                                                </div>
                                            <div class="form-group row">
