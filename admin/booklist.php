...
<h4 class="card-title"><i class="fi fi-rr-book-open-cover"></i> List of Book </h4>
<div class="line"></div><br><br>
<div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
<a href="add-books.php"><button type="button" class="btn btn-block btn-outline-dark"><i class="fi fi-rr-square-plus" style="font-size: 20px;"></i>  Add Books</button></a>
</div><br>
<div class="search-box mb-3" id="list">
                  ...
                  <td><?php echo $books["libraryUserFirtsName"]." ".$books["libraryUserLastName"]?></td>
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="add-books.php?edit=<?php echo $books["bookId"]; ?>" onclick="return confirm('Are you sure?')"  class="btn "><i class="fi fi-rr-edit" style="font-size: 20px;"></i></a>
                        <a href="add-books.php?delete_id=<?php echo $books["bookId"]; ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm "><i class="fi fi-rr-trash" style="font-size: 20px;"></i></a>
                      </div>
                    </td>
                </tr>
			<?php 
...
<script>
    $(document).ready(function(){
        $('#list input[type="text"]').on("keyup input", function(){
            /* Get input value on change */
            var inputVal = $(this).val();
            var resultDropdown = $(this).siblings(".result");
            if(inputVal.length){
                $.get("search.php", {listz: inputVal}).done(function(data){
